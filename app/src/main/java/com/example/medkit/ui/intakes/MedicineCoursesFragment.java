...
public class MedicineCoursesFragment extends Fragment {

    private MedicineCoursesViewModel viewModel;

    private FragmentMedicineCoursesBinding binding;
    private boolean isOptionsMenuShowing = false;

    public static MedicineCoursesFragment newInstance() {
        return new MedicineCoursesFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        binding = FragmentMedicineCoursesBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(MedicineCoursesViewModel.class);
        setupTollbar();
        setupOptionsMenu();
        setupNavigateMedCourseCard();
    }

    private void setupNavigateMedCourseCard() {
        binding.medCourseCard.setOnClickListener(v -> {
            Navigation.findNavController(v).navigate(R.id.med_course);
        });
    }
